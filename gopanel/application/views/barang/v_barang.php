...
<section class="content">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="box-body pad">
                  <form action="<?=base_url()?>barang/upload_process" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Masukan Kode Barang. . ." name="kode" required>
                    </div>
                    <div class="form-group">
                    <label>Nama Sub Kategori</label>
                        <select name="ref_sktg" class="js-example-basic-single" style="width: 100%;">
                        <?php
                    ...
                    <label>Jenis Barang</label>
                        <select name="ref_jenisbarang" class="js-example-basic-single" style="width: 100%;">
                        <?php
                    ...
                    <div class="form-group">
                      <label>Status</label>
                        <select name="status" id="status" class="js-example-basic-single" style="width: 100%;">
                          ?>
                          <option id="" name="" value="t" >Tampil</option>
                          <option id="" name="" value="f" >Tidak Tampil</option>
                      </select>
                      </div>
                    <div class="form-group">
                      <label>Gambar</label>
          ...
          <div class="modal fade" id="edit-data" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="box-body pad">
                    <form action="<?=base_url()?>barang/update" method="post" enctype="multipart/form-data" id="form">
                    ...
                    <div class="form-group">
                    <label>Nama Sub Kategori</label>
                        <select name="editref_sktg" id="editref_sktg" class="js-example-basic-single" style="width: 100%;">
                        <?php
                          foreach($msubkategori as $t)
                          {
                          ?>
                      ...
                      <div class="form-group">
                      <label>Jenis Barang</label>
                        <select name="editref_jenisbarang" id="editref_jenisbarang" class="js-example-basic-single" style="width: 100%;">
                        <?php
                          foreach($mjenisbarang as $t)
                          {
                          ?>
                      ...
                      <div class="form-group">
                        <label>Harga</label>
                        <input type="text" class="form-control" placeholder="Masukan Harga. . ." name="editharga" id="editharga" value="" required>
                      </div>
                      <div class="form-group">
                      <label>Status</label>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  if ($t->status=='t') {
                    ...
                    echo '<span class="label label-danger">Tidak Tampil</span>' ;
                    }?>
                  </td>
                  <td><img src="<?php echo base_url ('uploads/barang/'.$t->image) ?>" style="width: 75px; height: 50px;"
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-warning edit_data" id="<?php echo $t->id ?>" data-toggle="tooltip" data-placement="top" title="Edit" ><span class="glyphicon glyphicon-pencil"></button>
                      <?php echo anchor('barang/hapus/'.$t->id,'<button class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><span class="glyphicon glyphicon-trash"></button>'); ?>
                        <?php
                        $no++;}
                        ?>
                      </tr>
  ...
  $('select').select2();
      ...
      $.ajax({
      url: "<?php echo site_url('barang/editu/') ;?>/" + editid,
      method:"POST",
      data:{editid:editid},
      dataType:"json",
      ...
      $('#editref_sktg').val(data.ref_sktg);
      $('#editref_jenisbarang').val(data.ref_jenisbarang);
      $('#editket').val(data.ket);
      $('#editharga').val(data.harga);
      $('#editstatus').val(data.status);
      $('#editfilelama').val(data.image);
      var php = "<?php echo base_url('uploads/barang') ?>";
