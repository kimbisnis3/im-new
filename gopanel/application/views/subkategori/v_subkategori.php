...
<section class="content">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="box-body pad">
                  <form action="<?=base_url()?>subkategori/upload_process" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>Nama Sub Kategori</label>
                      <input type="text" class="form-control" placeholder="Masukan Nama subkategori. . ." name="namasubkategori" required>
                    </div>
                    <div class="form-group">
                    <label>Nama Kategori</label>
                        <select name="ref_ktg" class="js-example-basic-single" style="width: 100%;">
                        <?php
                          foreach($mkategori as $t)
                          {
                          ?>
                          <option value="<?php echo $t->kode ?>">
                          <?php echo $t->namakategori ?>
                          </option>
                          <?php }?>
                      </select>
                      </div>
                    <div class="form-group">
                      <label>Gambar</label>
                      <input type="file" class="form-control" placeholder="Masukan namasubkategori. . ." name="image" id="image">
                    </div>
                    <div class="form-group">
          ...
          <div class="modal fade" id="edit-data" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Edit Data Sub Kategori </h4>
                </div>
                <div class="modal-body">
                  <div class="box-body pad">
                    <form action="<?=base_url()?>subkategori/update" method="post" enctype="multipart/form-data" id="form">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukan Nama subkategori. . ." name="editnamasubkategori" id="editnamasubkategori" value="">
                      </div>
                      <div class="form-group">
                      <label>Nama Kategori</label>
                        <select name="editref_ktg"  id="editref_ktg" class="js-example-basic-single" style="width: 100%;">
                        <?php
                          foreach($mkategori as $t)
                          {
                          ?>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url ('uploads/subkategori/'.$t->image) ?>" style="width: 75px; height: 50px;"
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-warning edit_data" id="<?php echo $t->id ?>" data-toggle="tooltip" data-placement="top" title="Edit" ><span class="glyphicon glyphicon-pencil"></button>
                      <?php echo anchor('subkategori/hapus/'.$t->id,'<button class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><span class="glyphicon glyphicon-trash"></button>'); ?>
                        <?php
                        $no++;}
                        ?>
                      </tr>
  ...
  $( ".master" ).addClass( "active" );
      ...
      $.ajax({
      url: "<?php echo site_url('subkategori/editu/') ;?>/" + editid,
      method:"POST",
      data:{editid:editid},
      dataType:"json",
      success:function(data){
      $('#editid').val(data.id);
      $('#editnamasubkategori').val(data.namasubkategori);
      $('#editket').val(data.ket);
      $('#editref_ktg').val(data.ref_ktg);
      $('#editfilelama').val(data.image);
      var php = "<?php echo base_url('uploads/subkategori') ?>";
