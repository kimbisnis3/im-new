...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Order Hari Ini</li>
  </ol>
</section>
<!-- Main content -->
              ...
              <tbody>
                ...
                <td><strong><?php echo $t->koderef ?></strong></td>
                  ...
                  <td>
                    ...
                    <?php echo anchor('order/print/'.$t->id,'<button class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Print"><i class="fa fa-print" aria-hidden="true" target="_blank"></i></button>'); ?>
                        <?php
                        $no++;}
                        ?>
                      </tr>
