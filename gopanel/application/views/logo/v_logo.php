...
<section class="content">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah Data Logo</h4>
              </div>
              <div class="modal-body">
                <div class="box-body pad">
                  <form action="<?=base_url()?>logo/upload_process" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>Nama logo</label>
                      <input type="text" class="form-control" placeholder="Masukan Nama logo. . ." name="nama" required>
                    </div>
                    <div class="form-group">
                      <label>Gambar</label>
          ...
          <div class="modal fade" id="edit-data" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="box-body pad">
                    <form action="<?=base_url()?>logo/update" method="post" enctype="multipart/form-data" id="form">
                      <input type="hidden" class="form-control" placeholder="ID" name="editid" id="editid" style="width: 15%;" value="" readonly="true">
                      <div class="form-group">
                        <label>Nama logo</label>
                        <input type="text" class="form-control" placeholder="Masukan Nama logo. . ." name="editnama" id="editnama" value="">
                      </div>
                      <div class="form-group">
                        <label>Gambar</label>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url ('uploads/logo/'.$t->image) ?>" style="width: 75px; height: 50px;"
                  onerror="this.src='<?php echo base_url ('gambar/noimage.png') ?>';"></td>
                  <td>
                    <button type="button" class="btn btn-sm btn-warning edit_data" id="<?php echo $t->id ?>" data-toggle="tooltip" data-placement="top" title="Ubah Logo" ><span class="glyphicon glyphicon-pencil"></button>
                    <!--  <?php echo anchor('logo/hapus/'.$t->id,'<button class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><span class="glyphicon glyphicon-trash"></button>'); ?>-->
                        <?php
                        $no++;}
                        ?>
                      </tr>
  ...
  $( ".ib" ).addClass( "active" );
	...
	$( ".logo" ).addClass( "active" );
      ...
      $.ajax({
      url: "<?php echo site_url('logo/editu/') ;?>/" + editid,
      method:"POST",
      data:{editid:editid},
      dataType:"json",
