...
<section class="content">
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Edit Data guest</h4>
                </div>
                <div class="modal-body">
                  <div class="box-body pad">
                    <form action="<?=base_url()?>guest/update" method="post" enctype="multipart/form-data" id="form">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukan Nama guest. . ." name="editnama" id="editnama" value="">
                      </div>
                      <div class="form-group">
                        <label>Gambar</label>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-warning edit_data" id="<?php echo $t->id ?>" data-toggle="tooltip" data-placement="top" title="Edit" ><span class="glyphicon glyphicon-pencil"></button>
                      <?php echo anchor('guest/hapus/'.$t->id,'<button class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><span class="glyphicon glyphicon-trash"></button>'); ?>
                        <?php
                        $no++;}
                        ?>
                      </tr>
  ...
  $( ".customer" ).addClass( "active" );
	...
	$( ".guest" ).addClass( "active" );
      ...
      $.ajax({
      url: "<?php echo site_url('guest/editu/') ;?>/" + editid,
      method:"POST",
      data:{editid:editid},
      dataType:"json",
