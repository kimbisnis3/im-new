            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="box-body pad">
                  <form action="<?=base_url()?>ekspedisi/tambah" method="post" enctype="multipart/form-data">
          ...
          <div class="modal fade" id="edit-data" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="box-body pad">
                    <form action="<?=base_url()?>ekspedisi/update" method="post" enctype="multipart/form-data" id="form">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
           ...
           <button type="button" class="btn btn-sm btn-warning edit_data" id="<?php echo $t->id ?>" data-toggle="tooltip" data-placement="top" title="Edit" ><span class="glyphicon glyphicon-pencil"></button>
            <?php echo anchor('ekspedisi/hapus/'.$t->id,'<button class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><span class="glyphicon glyphicon-trash"></button>'); ?>
...
<script>
        ...
        $.ajax({
        url: "<?php echo site_url('ekspedisi/editu/') ;?>/" + editid,
        method:"POST",
        data:{editid:editid},
        dataType:"json",
