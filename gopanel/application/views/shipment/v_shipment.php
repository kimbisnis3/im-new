          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah Data shipment</h4>
              </div>
              <div class="modal-body">
                <div class="box-body pad">
                  <form action="<?=base_url()?>shipment/tambah" method="post" enctype="multipart/form-data">
          ...
          <div class="modal fade" id="edit-data" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Edit Data shipment</h4>
                </div>
                <div class="modal-body">
                  <div class="box-body pad">
                    <form action="<?=base_url()?>shipment/update" method="post" enctype="multipart/form-data" id="form">
                    ...
                    <div class="form-group">
                      <label>Harga</label>
                      <input type="text" class="form-control" placeholder="Masukan Harga. . ." name="editharga" id="editharga" required>
                    </div>
                    <div class="form-group">
                      <label>Keterangan</label>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
           ...
           <button type="button" class="btn btn-sm btn-warning edit_data" id="<?php echo $t->id ?>" data-toggle="tooltip" data-placement="top" title="Edit" ><span class="glyphicon glyphicon-pencil"></button>
            <?php echo anchor('shipment/hapus/'.$t->id,'<button class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><span class="glyphicon glyphicon-trash"></button>'); ?>
...
<script>
        ...
        $.ajax({
        url: "<?php echo site_url('shipment/editu/') ;?>/" + editid,
        method:"POST",
        data:{editid:editid},
        dataType:"json",
