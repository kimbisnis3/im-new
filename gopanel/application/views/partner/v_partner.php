...
<section class="content">
  <div class="row">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="box-body pad">
                  <form action="<?=base_url()?>partner/upload_process" method="post" enctype="multipart/form-data">
          ...
          <div class="modal fade" id="edit-data" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="box-body pad">
                    <form action="<?=base_url()?>partner/update" method="post" enctype="multipart/form-data" id="form">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $no=1;
                foreach($mpartner as $t)
                { ?>
                <tr>
                  <td><?php echo $no ?></td>
                  <td><?php echo $t->judul ?></td>
                  <td><img src="<?php echo base_url ('uploads/partner/'.$t->image) ?>" style="width: 75px; height: 50px;"
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-warning edit_data" id="<?php echo $t->id ?>" data-toggle="tooltip" data-placement="top" title="Edit" ><span class="glyphicon glyphicon-pencil"></button>
                      <?php echo anchor('partner/hapus/'.$t->id,'<button class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><span class="glyphicon glyphicon-trash"></button>'); ?>
                        <?php
                        $no++;}
                        ?>
                      </tr>
	...
	$( ".partner" ).addClass( "active" );
      ...
      $.ajax({
      url: "<?php echo site_url('partner/editu/') ;?>/" + editid,
      method:"POST",
      data:{editid:editid},
      dataType:"json",
