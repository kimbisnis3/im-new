          ...
          <nav class="header-main-nav">
            <div id="banner-header-top" class="content-banner banner-header-top" data-cms-area="header_banner_top" data-cms-area-filters="global">
              <div class="cms-content cms-content-html" id="cms-content-69-69">
                <div class="container-fluid promo"><span>FREE SHIPPING ON U.S. ORDERS $99+</span></div>
              </div>
            </div>
            <div class="header-sidebar-toggle-wrapper"><button class="header-sidebar-toggle" data-action="header-sidebar-show"><i class="header-sidebar-toggle-icon"></i></button></div>
            <div class="header-content">
              <div class="header-logo-wrapper">
                <div data-view="Header.Logo">
                  <div id="site-logo" class="content-banner"></div><a class="header-logo" href="<?php echo base_url(''); ?>" data-touchpoint="home" data-hashtag="#" title="IM"><noscript><img class="header-logo-image" src="<?php echo base_url('gopanel/uploads/logo/pr_1_e1498964325.png'); ?>" alt=""/></noscript>
                    <noscript><img class="header-mobile-logo-image" src="<?php echo base_url('gopanel/uploads/logo/pr_1_e1498964325.png'); ?>" alt=""/>
                  </noscript></a>
                </div>
              </div>
              <div class="header--navigation" data-view="Header.Menu">
                <nav class="header-menu-secondary-nav">
                  <ul class="header-menu-level1">
                    ...
                    <li><a class="header-menu-level1-anchor" href="<?php echo base_url('about') ;?>" data-touchpoint="home" data-hashtag="#/custom-paint"> About </a></li>
              ...
              <div class="header-right-menu">
                <div class="header-menu-store-locator"><a href="store-locator.html"><span class="btn glyphicon glyphicon-map-marker"></span></a></div>
                <div class="header-menu-profile" data-view="Header.Profile">
                  <div class="header-profile-menu-login-container">
                    <ul class="header-profile-menu-login">
                      <li class="header-profile-desktop-login-link"><a class="header-profile-login-link" data-touchpoint="login" data-hashtag="login-register" href="#"><span class="btn glyphicon glyphicon-user"></span></a></li>
                ...
                <td colspan="4" align="right">
                        <a href="<?php echo base_url('shop/delete'); ?>" type="button" class ='btn btn-danger empty' value="Clear Cart" >Clear Cart</a>
                            ...
                            <input type="button" class ='btn btn-info' value="Place Order" onclick="window.location = 'billing/guest'">
                          </td>
                    </tr>
              <?php endif; ?>
            </table>
        ...
        <ul class="header-menu-level1">
          <li><a class="header-menu-home-anchor" href="index.html" data-touchpoint="home" data-hashtag="#/" data-toggle="dropdown"> Shop </a>
            <ul class="header-menu-level-container">
              <li>
                <ul class="header-menu-level2">
                  <li><a class="header-menu-level2-anchor " href="moto.html" data-hashtag="#/moto" data-touchpoint="home">moto</a>
                    <ul class="header-menu-level3">
                      <li><a class="header-menu-level3-anchor " href="moto/helmets.html" data-hashtag="#/moto/helmets" data-touchpoint="home">helmets</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/jerseys.html" data-hashtag="#/moto/jerseys" data-touchpoint="home">jerseys</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/pants.html" data-hashtag="#/moto/pants" data-touchpoint="home">pants</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/gearbags.html" data-hashtag="#/moto/gearbags" data-touchpoint="home">gear bags</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/gloves.html" data-hashtag="#/moto/gloves" data-touchpoint="home">gloves</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/socks.html" data-hashtag="#/moto/socks" data-touchpoint="home">socks</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/jackets.html" data-hashtag="#/moto/jackets" data-touchpoint="home">jackets</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/protection.html" data-hashtag="#/moto/protection" data-touchpoint="home">protection</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/accessories.html" data-hashtag="#/moto/accessories" data-touchpoint="home">accessories</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/women.html" data-hashtag="#/moto/women" data-touchpoint="home">women</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/youth.html" data-hashtag="#/moto/youth" data-touchpoint="home">youth</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/collections.html" data-hashtag="#/moto/collections" data-touchpoint="home">collections</a></li>
                      <li><a class="header-menu-level3-anchor " href="moto/boots.html" data-hashtag="#/moto/boots" data-touchpoint="home">boots</a></li>
                    </ul>
                  </li>
